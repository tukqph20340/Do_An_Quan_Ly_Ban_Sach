        ...
        <div class="col-10 px-0">
            ...
            <div class="px-4 p-3">
                <div class="modal-body">
                    <form action="/admin/dia-chi/update" method="post">
                        <div class="row">
                            <input type="hidden" class="form-control" name="id" value="${detail.idDC}"/>
                            <div class="col-12">
                                <label>Mã Địa Chỉ</label>
                                <input type="text" class="form-control" name="ma" value="${detail.maDC}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="thanhPho" value="${detail.thanhPho}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <label>Quốc Gia</label>
                                <input type="text" class="form-control" name="quocGia" value="${detail.quocGia}"/>
                            </div>
                        </div>
