            ...
            <div class="px-4 p-3">
                <div class="modal-body">
                    <form action="/admin/khach-hang/update" method="post">
                        <input type="hidden" class="form-control" name="idKH" value="${detail.idKH}"/>
                            <div class="col-12">
                                <label>Địa Chỉ</label>
                                <br>
                                <select name="idDC">
                                    <c:forEach items="${listDC}" var="l">
                                        <option value="${l.idDC}" ${detail.diaChi.idDC==l.idDC?"selected":""} >${l.diaChi}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        <div class="row">
                            <div class="col-12">
                                <label>Mã</label>
                                <input type="text" class="form-control" name="maKH" value="${detail.maKH}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="radio" value="1" ${detail.trangThai==1?"checked":""} name="trangThai" checked="checked"/> Hoạt Động
                                <input type="radio" value="0" ${detail.trangThai==0?"checked":""} name="trangThai"/> Chưa Hoạt Động
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
