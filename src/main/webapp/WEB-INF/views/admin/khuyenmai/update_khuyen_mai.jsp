        ...
        <div class="col-10 px-0">
            ...
            <div class="px-4 p-3">
                <div class="modal-body">
                    <form action="/admin/khuyen-mai/update/${detail.id}" method="post">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label>Tên</label>
                                <input type="date" class="form-control" name="ngayTao" value="${detail.ngayTao}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="date" class="form-control" name="ngayKetThuc" value="${detail.ngayKetThuc}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="trangThai" value="${detail.trangThai }"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
