                                    ...
                                    <div class="modal-body">
                                        <form action="/admin/tac-gia/add" method="post">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label>Mã</label>
                                                    <input type="text" class="form-control" name="maTG"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
...
<%--                                    </div>--%>
<%--                                    <div class="modal-body">--%>
<%--                                        <form action="/admin/tac-gia/tim-kiem" method="get">--%>
<%--                                            <div class="row">--%>
<%--                                                <div class="col-12">--%>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#modalUpdate_${l.idTG}">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </button> <!-- Modal update -->
                                        <div class="modal fade" id="modalUpdate_${l.idTG}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <a role="button"
                                                           href="/admin/tac-gia/viewUpdate?id=${l.idTG}"
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalDelte_${l.idTG}">
                                            <i class="fa-solid fa-trash-can"></i>
                                        </button> <!-- Modal delete -->
                                        <div class="modal fade" id="modalDelte_${l.idTG}"
                                             data-bs-backdrop="static" data-bs-keyboard="false"
                                             tabindex="-1" aria-labelledby="staticBackdropLabel"
                                             aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" style="background-color: #fff2df">
                                                        ...
                                                        <a role="button"
                                                           href="/admin/tac-gia/delete?id=${l.idTG}"
                                            ...
                                            <ul class="pagination justify-content-center">
                                                <c:forEach var="index" begin="0" end="${ list.totalPages - 1 }">
                                                    <li class="page-item mx-1"><a
                                                            ...
                                                            href="/admin/tac-gia/hien-thi?page=${ index }">${ index + 1 }</a>
                                                    </li>
                                                </c:forEach>
                                            </ul>
                                        </div>
