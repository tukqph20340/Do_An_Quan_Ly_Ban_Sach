                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <select name="id">
                                                        <c:forEach items="${listGP}" var="l">
                                                            <option value="${l.id}">${l.soGiayPhep}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
...
<%--                                    </div>--%>
<%--                                    <div class="modal-body">--%>
<%--                                        <form action="/admin/ban-quyen/tim-kiem" method="get">--%>
<%--                                            <div class="row">--%>
<%--                                                <div class="col-12">--%>
<%--                                                    <label> Ngày Bắt Đầu </label>--%>
<%--                                                    <input type="date" class="form-control" name="ngayBatDau"/>--%>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <a role="button"
                                                           href="/admin/ban-quyen/viewUpdate?id=${l.id}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" style="background-color: #fff2df">
                                                        ...
                                                        <a role="button"
                                                           href="/admin/ban-quyen/delete?id=${l.id}"
                                            ...
                                            <ul class="pagination justify-content-center">
                                                <c:forEach var="index" begin="0" end="${ list.totalPages - 1 }">
                                                    <li class="page-item mx-1"><a
                                                            ...
                                                            href="/admin/ban-quyen/hien-thi?page=${ index }">${ index + 1 }</a>
                                                    </li>
                                                </c:forEach>
                                            </ul>
                                        </div>
