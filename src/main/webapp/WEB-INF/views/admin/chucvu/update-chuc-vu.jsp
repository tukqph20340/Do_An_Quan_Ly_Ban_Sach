        ...
        <div class="col-10 px-0">
            ...
            <div class="px-4 p-3">
                <div class="modal-body">
                    <form action="/admin/chuc-vu/update" method="post">
                        <div class="row">
                            <input type="hidden" class="form-control" name="id" value="${detail.idCV}"/>
                            <div class="col-12">
                                <label>Mã Chức Vụ</label>
                                <input type="text" class="form-control" name="ma" value="${detail.maCV}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <label>Tên</label>
                                <input type="text" class="form-control" name="ten" value="${detail.tenCV}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
