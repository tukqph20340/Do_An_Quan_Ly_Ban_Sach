        ...
        <div class="col-10 px-0">
            ...
            <div class="px-4 p-3">
                <div class="modal-body">
                    <form action="/admin/nguoi-dung/update" method="post">
                        <input type="hidden" class="form-control" name="id"value="${detail.idND}"/>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <select name="chucVu">
                                    <c:forEach items="${listCV}" var="l">
                                        <option value="${l.idCV}" ${detail.chucVu.idCV==l.idCV?"selected":""} >${l.tenCV}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="ma" value="${detail.maND}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <label>Tên</label>
                                <input type="text" class="form-control" name="ten" value="${detail.hoVaTen}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <label>Giới Tính</label>
                                <input type="radio" name="gioiTinh" value="1" ${detail.gioiTinh==1?"checked":""} hoVaTen />
                                Nam
                                <input type="radio" name="gioiTinh" value="0" ${detail.gioiTinh==0?"checked":""}/> Nữ
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label>Mô Tả</label>
                                <input type="text" class="form-control" name="mo_ta" value="${detail.moTa}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <label>Link Ảnh</label>
                                <input type="number" class="form-control" name="anh" value="${detail.anh}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="tk" value="${detail.taiKhoan}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <label>Mật Khẩu</label>
                                <input type="password" class="form-control" name="mk" value="${detail.matKhau}"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
