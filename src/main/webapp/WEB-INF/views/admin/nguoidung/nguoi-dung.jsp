                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/admin/nguoi-dung/add" method="post">
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <select name="chucVu">
                                                        <c:forEach items="${listCV}" var="l">
                                                            <option value="${l.idCV}">${l.tenCV}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <input type="number" class="form-control" name="anh"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                ...
                <table class="table table-bordered">
                    ...
                    <c:forEach items="${ list.content}" var="l">
                        <tr>
                            ...
                            <td>${l.moTa}</td>
                            <td>${l.sdt}</td>
                            <td><img src="${l.anh}" height="80px" width="80px"></td>
                            <td>${l.taiKhoan}</td>
                            <td>${l.matKhau}</td>
                            <td>
                                <button class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#modalUpdate_${l.idND}">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </button> <!-- Modal update -->
                                <div class="modal fade" id="modalUpdate_${l.idND}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <a role="button"
                                                   href="/admin/nguoi-dung/viewUpdate?id=${l.idND}"
                            ...
                            <td class="text-center">
                                <button class="btn btn-danger" data-bs-toggle="modal"
                                        data-bs-target="#modalDelte_${l.idND}">
                                    <i class="fa-solid fa-trash-can"></i>
                                </button> <!-- Modal delete -->
                                <div class="modal fade" id="modalDelte_${l.idND}"
                                     data-bs-backdrop="static" data-bs-keyboard="false"
                                     tabindex="-1" aria-labelledby="staticBackdropLabel"
                                     aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body"
                                                ...
                                                <p>Warning : Bạn Có Muốn Xóa  Không
                                                    !</p>
                                                <a role="button"
                                                   href="/admin/nguoi-dung/delete?id=${l.idND}"
                ...
                <ul class="pagination justify-content-center">
                    <c:forEach var="index" begin="0" end="${ list.totalPages - 1 }">
                        <li class="page-item mx-1"><a
                                ...
                                href="/admin/nguoi-dung/hien-thi?page=${ index }">${ index + 1 }</a>
                        </li>
                    </c:forEach>
                </ul>
            </div>
