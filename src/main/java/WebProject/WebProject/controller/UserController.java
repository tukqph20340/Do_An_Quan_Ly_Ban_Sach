...
//		User user = userService.getUserById(loginname);
	...
	public String SignUp(@ModelAttribute("username") String id, @ModelAttribute("your_email") String email,
		...
		if (user == null) {
			...
			User newUser = new User(id, "default", "user", encodedValue, fullname, avatar, email, null, null, null,null,null,null,null,null);
			userService.saveUser(newUser);
			User user111 = userService.detail(id);
			wallet.setUser(user111);
			wallet.setPrice(Float.valueOf(0));
